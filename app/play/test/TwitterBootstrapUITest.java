...
public abstract class TwitterBootstrapUITest extends UITest {
  protected static void closeModal(By by) {
    getElement(by).sendKeys(ESCAPE);
    waitUntil(by, hidden);
  }

  protected static void assertSuccessMessage(String message) {
    assertElement(By.className("alert-success"), hasText(message));
  }

  protected static void assertWarningMessage(String message) {
    assertElement(By.className("alert-warning"), hasText(message));
  }

  protected static void assertInfoMessage(String message) {
    assertElement(By.className("alert-info"), hasText(message));
  }

  protected static void assertErrorMessage(String message) {
    assertElement(By.className("alert-error"), hasText(message));
  }

  @SuppressWarnings("StatementWithEmptyBody")
  protected static void assertFieldHasError(String name, String message) {
