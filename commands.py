...
COMMANDS = ["tests", "compile", "clean-tests", "unit-tests", "ui-tests",
            "tests2", "clean-tests2", "unit-tests2", "ui-tests2", "itests"]

HELP = {
    "tests": "Compile and run all tests",
    "tests2": "Compile and run all tests with Gradle (in parallel)",
    "compile": "Compile all the tests with Java code",
    "clean-tests": "Clean compiled tests and test results",
    "clean-tests2": "Clean compiled tests and test results (generated by Gradle)",
...
def execute(**kargs):
    ...
    if command == 'tests':
        ...
        clean_tests(app)
    elif command == 'clean-tests2':
        run_tests2(app, args, 'clean')
    elif command == 'unit-tests':
        run_unit_tests(app, args, test_class_name, is_random_order, include, exclude)
    elif command == 'ui-tests':
        run_ui_tests(app, args, test_class_name, is_random_order, include, exclude)
    elif command == 'unit-tests2':
        run_tests2(app, args, 'test')
    elif command == 'ui-tests2':
        run_tests2(app, args, 'uitest')
    elif command == 'itests':
        run_tests2(app, args, 'itest')
    elif command == 'tests2':
        run_tests2(app, args, 'clean', 'test', 'itest', 'uitest')
    else:
